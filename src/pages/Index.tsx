        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left space-y-8 animate-fade-up">
             ...
             <b>ANDY MOVEE</b>  is your trusted partner in logistics and delivery services. We ensure your packages arrive safely and on time.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <span>+44 7965 646812</span>
              </div>
              <div className="flex items-center space-x-4">
                <Mail className="text-danger" size={24} />
                <span>info@andymove.co.uk</span>
              </div>
              <div className="flex items-center space-x-4">
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">ANDY MOVEE</h3>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>&copy; 2025 ANDY MOVEE. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
